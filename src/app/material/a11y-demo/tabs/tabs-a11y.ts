...
@Component({
	selector: 'app-a11y-tabs',
	templateUrl: 'tabs-a11y.html',
	styleUrls: ['tabs-a11y.scss '],
})
export class TabsAccessibilityDemoComponent {
	// Nav bar demo
	tabLinks = [
...
export class SunnyTabComponent {}

@Component({
	selector: 'app-rainy-routed-content',
	template: 'A rainy period of time is one when it rains a lot',
})
export class RainyTabComponent {}

@Component({
	selector: 'app-foggy-routed-content',
	template: 'If the weather is foggy, there is fog',
})
export class FoggyTabComponent {}
