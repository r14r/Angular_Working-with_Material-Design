...
import { CdkOverlayOrigin, HorizontalConnectionPos, Overlay, OverlayRef, VerticalConnectionPos } from '@angular/cdk/overlay';
...
export class ConnectedOverlayDemoComponent {
	...
	constructor(public overlay: Overlay, public viewContainerRef: ViewContainerRef, public dir: Directionality) {}
