...
import { FloatLabelType, MatFormFieldAppearance } from '@angular/material-experimental/mdc-form-field';
...
@Component({
	...
	selector: 'app-demo-mdc-input',
	templateUrl: 'mdc-input-demo.html',
	styleUrls: ['mdc-input-demo.scss '],
})
export class MdcInputDemoComponent {
