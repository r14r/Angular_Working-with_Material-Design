...
import { PopoverEditDemoComponent } from './popover-edit-demo';
...
@NgModule({
	imports: [
		...
		FormsModule,
		RouterModule.forChild([{ path: '', component: PopoverEditDemoComponent }]),
	],
	declarations: [PopoverEditDemoComponent],
})
export class PopoverEditDemoComponentModule {}
